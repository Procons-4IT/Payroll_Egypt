...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            'AddFields("Z_LEB_PAY_NSSFEOS", "Z_NoofYrs", "Year of Experience", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            ...
            addField("@Z_PAY_LEAVE", "Z_INCOM_TAX", "Affect Income Tax", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            ...
            AddTables("Z_OTAX", "Tax Definition", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("Z_OTAX", "Z_Year", "Tax Year", SAPbobsCOM.BoFieldTypes.db_Alpha, , 4)
            AddFields("Z_OTAX", "Z_Exemption", "Yearly Exemption", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)

            AddTables("Z_TAX1", "Tax Details breakup", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)
            AddFields("Z_TAX1", "Z_From", "Starting Slap", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_TAX1", "Z_End", "End Slap", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_TAX1", "Z_Percentage", "Tax Percentage", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Percentage)


            AddFields("Z_PAYROLL1", "Z_TaxBasic", "Basic Salary for Tax", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TEarning", "Earning for  Tax", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TDeduction", "Deductions for Tax", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TSocial", "Social Securty for Tax", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TExemption", "Tax Exemption", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TTotAmout", "Total Monthly Taxable Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TYTotAmount", "Yearly Taxable Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_TYearlyTax", "Yearly Tax Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_PAYROLL1", "Z_MonthlyTax", "Monthly  Tax", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)

            addField("@Z_PAY_OSBM", "Z_TAX", "Affect Tax", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            ...
            'tax amount field in Payroll1
            AddFields("Z_PAYROLL1", "Z_TaxLeave", "Taxable Leave Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            CreateUDO()
            oApplication.Utilities.Message("Initializing Database...", SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
    ...
    Public Sub CreateUDO()
        Try
            ...
            'Egypt Add-on
            AddUDO("Z_OTAX", "Tax Definition", "Z_OTAX", "U_Z_Year", "DocEntry", "Z_TAX1", , , SAPbobsCOM.BoUDOObjType.boud_Document)
