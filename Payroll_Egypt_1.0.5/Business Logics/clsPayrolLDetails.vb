    ...
    Private Sub databind(ByVal aform As SAPbouiCOM.Form, ByVal aCode As String)
        Try
            ...
            If oTemp1.RecordCount > 0 Then
                ...
                Dim s As String
                s = "Select  ""U_Z_MonthlyBasic"",""U_Z_Earning"",""U_Z_Deduction"",""U_Z_UnPaidLeave"",""U_Z_PaidLeave"",""U_Z_AnuLeave"",""U_Z_CashOutAmt"",""U_Z_Contri"",""U_Z_AirAmt"", ""U_Z_NetPayAmt"",""U_Z_CmpPayAmt"",U_Z_MonthlyTax 'Monthly Tax',""U_Z_Cost"",""U_Z_NetSalary"",""Code"",T0.""U_Z_EOS1"",T0.""U_Z_Leave"",T0.""U_Z_Ticket"",T0.""U_Z_Saving"" ,T0.""U_Z_PaidExtraSalary""  from [@Z_Payroll1] T0 where code='" & aCode & "'"
                ...
                'Tax Details
                oGrid = aform.Items.Item("36").Specific
                str = "SELECT T0.U_Z_YEAR 'Year',T0.U_Z_MONTH 'Month',T0.[U_Z_TaxBasic] 'Total Basic', T0.[U_Z_TEarning] 'Earnings', T0.[U_Z_TDeduction] 'Deductions', T0.[U_Z_TSocial] 'Social',T0.[U_Z_TaxLeave] 'Leave Amount', T0.[U_Z_TExemption] 'Monthly Exemption', T0.[U_Z_TTotAmout] 'Monthly Taxable Income', T0.[U_Z_TYTotAmount] 'Yearly Taxable Income', T0.[U_Z_TYearlyTax] 'Yearly Tax', T0.[U_Z_MonthlyTax] 'Monthly Tax' FROM [dbo].[@Z_PAYROLL1]  T0"
                str = str & " where U_Z_EmpID='" & streempid & "' and T0.[U_Z_Year]=" & intyear & " and T0.[U_Z_Month]<=" & intMonth & " order by T0.[U_Z_PayDate]"
                oGrid.DataTable.ExecuteQuery(str)
                oGrid.AutoResizeColumns()
