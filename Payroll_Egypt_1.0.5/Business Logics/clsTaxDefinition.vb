Public Class clsTaxDefinition
    ...
    Private Sub LoadForm()
        ...
        oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_TAX1")
...
#Region "Validations"
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        If oApplication.Utilities.getEdittextvalue(oForm, "6") = "" Then
            oApplication.Utilities.Message("Yearly Exemption Amount is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            aForm.Freeze(False)
            Return False
        End If
        ...
        If aForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            ...
            otemp.DoQuery("Select * from ""@Z_OTAX"" where ""U_Z_Year""='" & strterms & "'")
    ...
    Private Function CheckDuplicate(ByVal aCode As String, ByVal aform As SAPbouiCOM.Form) As Boolean
        Dim otemp As SAPbobsCOM.Recordset
        otemp = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
        otemp.DoQuery("Select * from ""@Z_OTAX"" where ""U_Z_Year""='" & aCode & "'")
        If otemp.RecordCount > 0 Then
            oApplication.Utilities.Message("This entry already exists .....", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return True
        End If
