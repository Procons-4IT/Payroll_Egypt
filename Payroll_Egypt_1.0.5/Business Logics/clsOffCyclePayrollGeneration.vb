    ...
    Private Function ResetPayrollWorksheet(ByVal aYear As Integer, ByVal aMonth As Integer, ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        If oTemp1.Fields.Item(1).Value = "V" Then
            ...
            If oTemp1.Fields.Item(0).Value = "P" Then
                If oApplication.Utilities.PostJournalVoucher_GroupbyBranch_Offcycle_Project(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
            ...
            ElseIf oTemp1.Fields.Item(0).Value = "E" Then
                If oApplication.Utilities.PostJournalVoucher_GroupbyBranch_OffCycle_Employee(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
                    oTemp1.DoQuery("Update [@Z_PAYROLL] set U_Z_Process='Y'  where  U_Z_OffCycle='Y' and  U_Z_CompNo='" & oCombobox.Selected.Value & "' and  U_Z_Year=" & aYear & " and U_Z_Month=" & aMonth & " and U_Z_Process='N'")
                    PrepareWorkSheet(oForm)
                    Return True
                Else
                ...
                End If
            Else
                If oApplication.Utilities.PostJournalVoucher_GroupbyBranch_OffCycle(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
                    oTemp1.DoQuery("Update [@Z_PAYROLL] set U_Z_Process='Y'  where ""U_Z_OffCycle""='Y' and U_Z_CompNo='" & oCombobox.Selected.Value & "' and  U_Z_Year=" & aYear & " and U_Z_Month=" & aMonth & " and U_Z_Process='N'")
                    PrepareWorkSheet(oForm)
                    Return True
                Else
        ...
        Else 'Journal Entry
            ...
            If oTemp1.Fields.Item(0).Value = "P" Then
                If oApplication.Utilities.PostJournalEntry_GroupbyBranch_Offcycle_Project(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
                    oTemp1.DoQuery("Update [@Z_PAYROLL] set U_Z_Process='Y'  where  U_Z_OffCycle='Y' and  U_Z_CompNo='" & oCombobox.Selected.Value & "' and  U_Z_Year=" & aYear & " and U_Z_Month=" & aMonth & " and U_Z_Process='N'")
                    PrepareWorkSheet(oForm)
                    Return True
                Else
                ...
                End If
            ElseIf oTemp1.Fields.Item(0).Value = "E" Then
                If oApplication.Utilities.PostJournalEntry_GroupbyBranch_OffCycle_Employee(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
                    oTemp1.DoQuery("Update [@Z_PAYROLL] set U_Z_Process='Y'  where  U_Z_OffCycle='Y' and  U_Z_CompNo='" & oCombobox.Selected.Value & "' and  U_Z_Year=" & aYear & " and U_Z_Month=" & aMonth & " and U_Z_Process='N'")
                    PrepareWorkSheet(oForm)
                    Return True
                Else
                ...
                End If
            Else
                If oApplication.Utilities.PostJournalEntriy_GroupbyBranch_OffCycle(aMonth, aYear, oCombobox.Selected.Value, strPostMethod) = True Then
                    oTemp1.DoQuery("Update [@Z_PAYROLL] set U_Z_Process='Y'  where ""U_Z_OffCycle""='Y' and U_Z_CompNo='" & oCombobox.Selected.Value & "' and  U_Z_Year=" & aYear & " and U_Z_Month=" & aMonth & " and U_Z_Process='N'")
                    PrepareWorkSheet(oForm)
                    Return True
                Else
