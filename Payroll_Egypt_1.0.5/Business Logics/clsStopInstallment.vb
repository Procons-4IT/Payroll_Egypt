    ...
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If OCHECKBOXCOLUMN.IsChecked(intRow) Then
                ...
                oRec.DoQuery("Select * from ""@Z_PAY15"" where ""U_Z_Status""='O' and  ""Code""='" & oGrid.DataTable.GetValue("RefCode", intRow) & "'")
...
#Region "Populate Employee Details"
    Private Sub PopulateEmployeeDetails(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            strQuery = strQuery & " where 1=1 and " & strEmpCondition & " and " & strDept & " and ""U_Z_Month""='" & strFromdate & "' and ""U_Z_Status""='O' and  ""U_Z_Year""='" & strToDate & "' order by T1.""U_Z_EmpID"",""U_Z_LoanCode"",""U_Z_TrnsRefCode"" "
