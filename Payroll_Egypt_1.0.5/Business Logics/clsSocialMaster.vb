...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        ...
        agrid.Columns.Item("U_Z_Tax").TitleObject.Caption = "Affect Tax"
        agrid.Columns.Item("U_Z_Tax").Type = SAPbouiCOM.BoGridColumnType.gct_CheckBox
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            If oGrid.DataTable.GetValue(2, intRow) <> "" Or oGrid.DataTable.GetValue(3, intRow) <> "" Then
                ...
                If oGrid.DataTable.GetValue(0, intRow) = "" Then
                    ...
                    OCHECKBOXCOLUMN = oGrid.Columns.Item("U_Z_Tax")
                    Try
                        If OCHECKBOXCOLUMN.IsChecked(intRow) = True Then
                            oUserTable.UserFields.Fields.Item("U_Z_Tax").Value = "Y"
                        Else
                            oUserTable.UserFields.Fields.Item("U_Z_Tax").Value = "N"
                        End If
                    Catch ex As Exception
                        oUserTable.UserFields.Fields.Item("U_Z_Tax").Value = "N"
                    End Try
